...
from magic_pdf.model.sub_modules.ocr.paddleocr.ppocr_273_mod import \
    ModifiedPaddleOCR
from magic_pdf.model.sub_modules.table.TableStructureRec.table_struct_rec import TableStructRec
...
def table_model_init(table_model_type, model_path, max_time, _device_='cpu', ocr_engine=None, table_sub_model_name=None):
    ...
    elif table_model_type == MODEL_NAME.TABLE_STRUCT_REC:
        table_model = TableStructRec()
    else:
