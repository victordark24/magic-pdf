...
class CustomPEKModel:
    ...
    def __init__(self, ocr: bool = False, show_log: bool = False, **kwargs):
        ...
        self.table_model_name = MODEL_NAME.TABLE_STRUCT_REC
        # self.table_model_name =  MODEL_NAME.RAPID_TABLE
        # self.table_model_name = self.table_config.get('model', MODEL_NAME.TABLE_MASTER)
        # print("Table model name:", self.table_model_name)
        # print("Weights config:", self.configs['weights'])
    ...
    def __call__(self, image):
        ...
        if self.apply_table:
            ...
            for res in table_res_list:
                ...
                elif self.table_model_name == MODEL_NAME.TABLE_STRUCT_REC:
                    print("im here")
